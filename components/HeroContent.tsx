...
const HeroContent = () => {
  return (
    <div className="flex flex-col justify-center h-fit w-[590px] gap-12">
      <div className="flex flex-col">
        <div className="w-fit h-[41px] rounded-full bg-white bg-opacity-5 flex justify-center items-center border border-[#CACACA] p-2 gap-3 text-white text-[16px] font-semibold">
